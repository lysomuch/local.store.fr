...
return [
    'modules' => [
        ...
        'Magento_Backend' => 1,
        'Dotsquares_Imexport' => 1,
        'Magento_Indexer' => 1,
        'Magento_CacheInvalidate' => 1,
        'Idevaffiliate_Idevaffiliate' => 1,
        'Magento_Cms' => 1,
        'Magento_Catalog' => 1,
        'Magento_Quote' => 1,
        ...
        'Silk_Cron' => 1,
        'Silk_Customer' => 1,
        'Silk_FacebookWallPost' => 1,
        'Silk_FlashSales' => 1,
        'Silk_Geoip' => 1,
        'Silk_Gift' => 1,
        'Silk_Idevaffiliate' => 1,
        'Silk_InStorePickUp' => 1,
        'Silk_Kingdee' => 1,
        'Silk_LayeredNavigation' => 1,
        'Silk_Newsletter' => 1,
        'Silk_OfflineShipping' => 1,
        'Silk_Olightcommands' => 1,
        'Silk_Paypal' => 1,
        'Silk_ProductList' => 1,
        'Silk_Quote' => 1,
        'Silk_Review' => 1,
