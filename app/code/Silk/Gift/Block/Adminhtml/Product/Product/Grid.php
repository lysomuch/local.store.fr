 ...
 */
namespace Silk\Gift\Block\Adminhtml\Product\Product;
...
class Grid extends \Magento\Catalog\Block\Adminhtml\Product\Grid
{
    ...
    {
        return $this->getUrl('gift/product/productGrid', ['_current' => true]);
    }
    ...
    {
        return $this->getUrl('gift/product/jsonProductInfo', ['id' => $row->getId()]);
    }
