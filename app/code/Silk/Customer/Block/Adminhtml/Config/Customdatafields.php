 ...
 * @date    18-5-31 上午10:35
 * @version 0.1.0
 */


namespace Silk\Customer\Block\Adminhtml\Config;
...
class Customdatafields extends \Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray
{
    ...
    {
        if ($columnName == 'group' && isset($this->_columns[$columnName])) {
        ...
        if ($columnName == 'amount' && isset($this->_columns[$columnName])) {
