...
class Validator extends \Magento\CatalogRule\Model\Rule
{
     ...
     * @return bool
     */
    public function validateProduct(\Amasty\Feed\Model\Feed $model, \Magento\Catalog\Api\Data\ProductInterface $product)
    {
        $cloneProduct = $this->_productFactory->create();
        $cloneProduct->setData($product->getData());
